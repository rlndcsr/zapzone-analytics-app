...
const CreateEventPurchaseScreen = () => {
  ...
  const handleSubmit = async () => {
    ...
    // add-on / discount change. `baseTotal` is synchronous, so it's current.
    ...
    const paid =
      isPayLater || isCardPayment ? 0 : typedPaid > 0 ? typedPaid : freshTotal;
