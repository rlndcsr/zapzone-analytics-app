...
export function AppUpdateDialog({ visible, status, onUpdate, onLater }: Props) {
  ...
  return (
    <Modal
      ...
      animationType="fade"
      // A forced update must survive the hardware back button.
      onRequestClose={blocking ? () => {} : onLater}
    >
      <View
      ...
      >
        ...
        <View className="w-full max-w-sm rounded-3xl bg-white p-6 dark:bg-neutral-900">
