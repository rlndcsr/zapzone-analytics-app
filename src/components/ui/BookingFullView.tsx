          ...
          <Section title="Payment Information">
            ...
            {!!detail.paymentMethod && (
              <InfoTile
                ...
                // The column stores "in_store" / "credit_card"; the web shows it
                // as prose, so the underscores never reach the screen.
                value={capitalize(detail.paymentMethod.replace(/_/g, " "))}
              />
            )}
            {!!card && (
