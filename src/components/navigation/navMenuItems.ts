...
export const NAV_MENU_ITEMS: NavMenuItem[] = [
  ...
  { key: "waivers", label: "Waivers", icon: "map-pin", route: "/waivers/waivers" },
  ...
  { key: "management", label: "User Management", icon: "users", route: "/management/management" },
  { key: "analytics", label: "Analytics & Reports", icon: "bar-chart-2", route: "/analytics/analytics" },
];
