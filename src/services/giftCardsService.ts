...
/** Fields for POST /api/gift-cards/purchase — mirrors the web counter-sale form. */
...
/** The gift card generated by a counter sale. */
...
export type PurchaseGiftCardResult = {
  success: boolean;
  message?: string;
  /** A repeat request the server recognised as already sold — still a success. */
  duplicate?: boolean;
  data: PurchasedGiftCard;
};

/** POST /api/gift-cards/purchase — sell a gift card at the counter. */
export async function purchaseGiftCard(
  token: string,
  input: PurchaseGiftCardInput,
): Promise<PurchaseGiftCardResult> {
  return apiRequest<PurchaseGiftCardResult>("/api/gift-cards/purchase", {
    method: "POST",
    token,
    body: input,
  });
